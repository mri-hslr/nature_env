...
export const HeroCurtains: React.FC<HeroCurtainsProps> = ({ scrollProgress }) => {
  const panels = [
    { id: 1, color: "#050505", start: 0.0, end: 0.35 },
    { id: 2, color: "#080808", start: 0.15, end: 0.50 },
    { id: 3, color: "#0a0a0a", start: 0.35, end: 0.7 },
    { id: 4, color: "#0c0c0c", start: 0.55, end: 0.90 },
    { id: 5, color: "#000000", start: 0.75, end: 1.0 },
  ];
